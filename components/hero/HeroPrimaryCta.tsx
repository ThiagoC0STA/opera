...
export function HeroPrimaryCta({ href = "#cta" }: HeroPrimaryCtaProps) {
  return (
    ...
    >
      <Link
        href={href}
        className="box-border flex h-14 min-h-14 w-full max-w-[min(323px,calc(100vw-2rem))] items-center justify-center rounded-[16px] border-2 border-[#232323] bg-[#FFBE3B] px-3 py-2 text-inherit no-underline uppercase leading-none transition-[filter] hover:brightness-[0.97] focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#232323] sm:h-[min(4.79vw,69px)] sm:min-h-0 sm:max-w-[323px] sm:rounded-[20px] sm:py-0 sm:px-0"
      >
        <ShadowText
